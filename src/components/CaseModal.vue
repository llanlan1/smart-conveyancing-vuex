      ...
      <v-col md="6" class="dialog-card-text-half-content">
        <v-row class="dialog-card-text-title-without-border">
          <v-col md="7">
            ...
            <v-label class="dialog-card-text-fields-label mt-2">Your Case Reference Number</v-label>
            <v-text-field
              v-if="isNew"
        ...
        <v-row dense class="mb-2 flex-grow-1">
          <v-col cols="12">
            <div class="document-drop-area d-flex flex-column align-center justify-center rounded-xl">
              ...
              <p class="text-grey mt-4 text-center">Start by drag and drop<br>OTP, IC, AML, LO, ACRA for biz, and<br>other documents</p>
            </div>
          </v-col>
        </v-row>
      </v-col>
        ...
        <div class="right-side-non-card-content">
          <div class="mb-4 flex-shrink-0">
            ...
            <div class="d-flex align-center">
              ...
              ></v-select>
              <v-btn-toggle v-model="roleType" mandatory rounded="xl" density="compact" class="ml-auto" color="grey-darken-4">
