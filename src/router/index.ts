    ...
    children: [
      {
        path: 'new',
        name: 'NewCase',
        component: () => import('@/components/dialog/NewCheckDialog.vue'),
        meta: { title: 'New Case' },
      },
      {
        path: ':id/detail',
        name: 'CaseDetail',
        component: () => import('@/components/dialog/CaseDetailDialog.vue'),
        meta: { title: 'Case Detail' },
      },
      {
        path: ':id/client',
        name: 'CaseClient',
        component: () => import('@/components/dialog/ClientDialog.vue'),
        meta: { title: 'Client Details' },
      },
      {
        path: ':id/shortfall',
        name: 'CaseShortfall',
        component: () => import('@/components/dialog/ShortfallDialog.vue'),
